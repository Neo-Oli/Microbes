...
this.feedvol=5;this.manualfed=0;this.autofed=0;this.feedspread=5;this.tps=100;this.debugvar=null;this.speedmod=50;this.counter;this.deaths=0;this.frameskip=1;this.width=0;this.height=0;this.achievements=new Array();this.achievementQ=new Array();this.achievementElement;this.achievementElementName;this.achievementElementBlurb;this.achievementDisplaytime=0;this.menuAchievementsElement;var ui=this;this.container=document.getElementById(id);var html="";html+='<div class="menutrigger">⚙</div>';html+='<div class="menu">';html+="<h3>Autofeed</h3>";html+='<label>less food</label><label>more food</label><input type="range" min="-250" max="500" class="slider reversed" id="foodmodslider" data-variable="foodmod"><div class="reset" data-target="foodmodslider">⟲</div>';html+='<h2>Achievements</h2>';html+='<div class="achievements"></div>';html+='<div class="stats"></div>';html+='</div>';html+='<canvas id="microbes" width="200" height="300">';html+='Your browser does not support the canvas element.';html+='</canvas>';html+='<div id="achievement">';html+='<div class="title">Achievement unlocked</div>';html+='<div class="name">null</div>';html+='<div class="blurb">null</div>';html+='</div>';this.container.innerHTML=html;var inputs=this.container.querySelectorAll("input");for(var i=0;i<inputs.length;i++){var element=inputs[i];element.value=this[element.getAttribute('data-variable')];element.setAttribute("data-default",element.value);element.addEventListener("change",function(e){element=e.originalTarget;var variable=element.getAttribute('data-variable');ui[variable]=parseInt(element.value)})}
...
updateCanvas(){var newWidth=this.canvas.offsetWidth;var newHeight=this.canvas.offsetHeight
if(this.width!=newWidth||this.height!=newHeight){this.canvas.width=this.canvas.offsetWidth;this.canvas.height=this.canvas.offsetHeight;this.width=newWidth;this.height=newHeight}}
...
var osec=start
var atps=this.tps;var ticks=0;var work=0;var ui=this
...
od=d;if(osec+1000<=d){atps=ui.tps
